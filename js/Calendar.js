	...
	for(var i = 0; i < tds.length; i++) {
		...
		if (dateArray[i]){
			tds[i].onclick = function () {
				...
				var dataArray = calendar.dateControl.value.split("-");
				y.innerHTML=dataArray[1] +"/"+ dataArray[0];
				d.innerHTML=dataArray[2];
				calendar.hide();
			}
...
Calendar.prototype.show = function (dateControl, popuControl,yy,dd) {
	y = yy;
	d = dd;
